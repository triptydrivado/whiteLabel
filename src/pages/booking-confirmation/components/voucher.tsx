...
interface AffiliateVoucherProps {
  companyName: string;
  companyLogo: string;
  name: string;
  bookingId: string;
...
const AffiliateVoucher: React.FC<AffiliateVoucherProps> = ({
  companyName,
  // companyLogo,
  name,
  bookingId,
  ...
  //   const scale = 2; // Ensure High-Quality Output
  ...
  //   pdf.save(`Booking_Voucher_${bookingId}.pdf`);
  // };

  return (
    <div
      className="mx-auto mt-0 min-h-[350mm] w-[210mm] rounded-lg border bg-white p-4 shadow-lg"
      ref={voucherRef}
    >
      <div className="p-2">
        ...
        <div className="mb-4 text-left">
          <p className="mt-4 text-lg  text-gray-900 leading-10">
            Dear, {name},
          </p>
        ...
        {/* ✅ Car Details */}
        <div className="mt-6 rounded-lg items-center border border-[#5E5E5E] border-opacity-40 bg-[#EAF0F333] px-4 pb-4 pt-1">
          <h3 className="mb-2 items-center border-b pb-4 text-left text-lg font-semibold text-gray-800">
            Car Details
          </h3>
...
export default AffiliateVoucher;
