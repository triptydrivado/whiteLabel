...
export default function DateDropdown() {
  return (
    <div className="relative">
      {/* Date Display Button */}
      <div className="group flex w-auto flex-1 items-center truncate rounded-lg border border-[#E9E9E9] bg-[#F9FAFB] p-[6px] transition-colors duration-300 hover:border-[#FFB1BA] hover:bg-gray-100 xl:p-3">
