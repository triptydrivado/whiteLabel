  ...
  return (
    <div className="relative">
      ...
      <div className="group flex max-w-[120px] items-center gap-x-3 rounded-lg bg-[#F5F6FA] p-[6px] transition-colors duration-300 xl:p-[10px]">
        <>
          <CapacityIcon className="h-3 min-h-3 w-3 min-w-3 flex-shrink-0 text-[var(--brand-icon-color)] transition-colors duration-300 lg:h-5 lg:w-5 2xl:h-[22px] 2xl:w-[22px]" />
