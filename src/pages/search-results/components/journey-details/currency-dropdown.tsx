...
export default function CurrencyDropdown() {
  return (
    <div className="relative">
      {/* Dropdown Trigger */}
      <div className="group flex w-full cursor-pointer items-center gap-x-3 rounded-lg border border-[#E9E9E9] bg-[#F9FAFB] p-[6px] transition-colors duration-300 hover:border-[#FFB1BA] hover:bg-[#FFF2F3] xl:p-[10px]">
