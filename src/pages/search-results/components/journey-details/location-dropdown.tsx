...
export default function LocationDropdown() {
  ...
  return (
    <div className="flex space-x-[15px]">
      ...
      <div className="group relative flex w-auto flex-1 cursor-pointer items-center gap-2 rounded-lg border border-[#E9E9E9] bg-[#F9FAFB] p-[6px] focus-within:border-[#FFF2F3] focus-within:bg-[#FFF2F3] hover:border-[#FFB1BA] hover:bg-[#FFF2F3] xl:p-3">
      ...
      <div className="group relative flex flex-1 cursor-pointer items-center gap-2 rounded-lg border border-[#E9E9E9] bg-[#F9FAFB] p-[6px] focus-within:bg-[#FFF2F3] hover:border-[#FFB1BA] hover:bg-[#FFF2F3] xl:p-3">
        <LocationIcon className="h-3 min-h-3 w-3 min-w-3 flex-shrink-0 text-[#999999] group-hover:text-[#FB4156] lg:h-5 lg:w-5 2xl:h-[22px] 2xl:w-[22px]" />
