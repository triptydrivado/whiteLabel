    ...
    <div className="relative mt-8 md:mt-8 xl:mt-6 2xl:mt-10">
      ...
      <div className="mt-3">
        <div className="mt-2 flex items-start space-x-3 xl:space-x-5">
          <div>
            <PickupDropoffIcon className="mt-1 size-3 text-[var(--brand-icon-color)] sm:mt-0.5 sm:size-3 md:size-3 xl:mt-1 xl:size-[14px]" />
          </div>
        ...
        <div className="relative mt-6 flex items-start space-x-3 xl:space-x-5">
          <div className="relative z-20">
            <PickupDropoffIcon className="mt-1 size-3 bg-white text-[var(--brand-icon-color)] sm:mt-0.5 sm:size-3 md:left-1.5 md:top-3.5 md:size-3 xl:mt-1 xl:size-[14px]" />
          </div>
